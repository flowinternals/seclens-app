...
/**
 * Build one markdown table row (21 cells) matching SCAN-TELEMETRY-LOG.md schema.
 * @param {object} params
...
export function buildTelemetryMarkdownTableRow({
  ...
  return `| ${ts} | ${repo} | ${profile} | ${maxFiles} | ${bytesPerFile} | ${totalEv} | ${treeCap} | ${sel} | ${capHits} | ${duration} | ${contract} | ${validation} | ${critic} | ${draftIn} | ${draftOut} | ${criticIn} | ${criticOut} | ${totalTok} | ${cost} | \`${escPipe(qa)}\` | ${correlation} |`
}
